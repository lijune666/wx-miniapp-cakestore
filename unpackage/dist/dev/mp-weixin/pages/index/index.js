...
/***/ 40:
/*!*************************************************************************************************!*\
  !*** /Users/lijun/LocalWarehouse/wx-miniapp-cakestore/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*************************************************************************************************/
...
/***/ 41:
/*!******************************************************************************!*\
  !*** /Users/lijun/LocalWarehouse/wx-miniapp-cakestore/pages/index/index.vue ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ 42:
/*!*************************************************************************************************************!*\
  !*** /Users/lijun/LocalWarehouse/wx-miniapp-cakestore/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*************************************************************************************************************/
...
/***/ 43:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/lijun/LocalWarehouse/wx-miniapp-cakestore/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
try {
  components = {
    cakeclass: function () {
      return __webpack_require__.e(/*! import() | components/cakeclass/cakeclass */ "components/cakeclass/cakeclass").then(__webpack_require__.bind(null, /*! @/components/cakeclass/cakeclass.vue */ 85))
    },
    cakeitem: function () {
      return __webpack_require__.e(/*! import() | components/cakeitem/cakeitem */ "components/cakeitem/cakeitem").then(__webpack_require__.bind(null, /*! @/components/cakeitem/cakeitem.vue */ 92))
    },
    uniSection: function () {
      return __webpack_require__.e(/*! import() | uni_modules/uni-section/components/uni-section/uni-section */ "uni_modules/uni-section/components/uni-section/uni-section").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-section/components/uni-section/uni-section.vue */ 67))
    },
    ...
    uniDataCheckbox: function () {
      return Promise.all(/*! import() | uni_modules/uni-data-checkbox/components/uni-data-checkbox/uni-data-checkbox */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uni-data-checkbox/components/uni-data-checkbox/uni-data-checkbox")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uni-data-checkbox/components/uni-data-checkbox/uni-data-checkbox.vue */ 106))
    },
  }
} catch (e) {
  if (
...
var render = function () {
  ...
  var g0 = JSON.stringify(_vm.radio)
...
/***/ 44:
/*!*******************************************************************************************************!*\
  !*** /Users/lijun/LocalWarehouse/wx-miniapp-cakestore/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 45:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/lijun/LocalWarehouse/wx-miniapp-cakestore/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  created: function created() {
    ...
    uni.request({
      ...
      success: function success(res) {
        _this.cakeMain = res.data;
      }
    });

    // 搜索
    uni.createSelectorQuery().select('.search').boundingClientRect(function (res) {
  ...
  onPageScroll: function onPageScroll(position) {
    // 左边栏和搜索框的固定
    var currentPosition = position.scrollTop;
    ...
    if (this.isFunctionRunning) {
      for (var i = 0; i < this.classDistances.length; i++) {
  ...
  watch: {
    cornerIcon: function cornerIcon(newVal, oldVal) {
      if (newVal !== oldVal) {
        if (newVal <= 0) {
  ...
  methods: {
    // 计算每个主题的距离
    computedClassDistances: function computedClassDistances() {
      var _this2 = this;
      this.cakeClasses.map(function (_, index) {
        var query = uni.createSelectorQuery().select('#class' + index);
        query.boundingClientRect(function (rect) {
          _this2.currentScrollTop = rect.top - _this2.searchHeight;
          _this2.classDistances.push(_this2.currentScrollTop);
        }).exec();
      });
    },
    // 点击主题滑到对应的部分
    onClassChose: function onClassChose(index) {
      var _this3 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this3.isFunctionRunning = false;
                _context.next = 4;
                return uni.pageScrollTo({
                  scrollTop: _this3.classDistances[index] + 1,
                  duration: 300
                });
              case 4:
                // 延长一秒，防止变为true太快导致页面滑动还没停止就开启监听了，这样最下面没有超过视窗顶的对应主题无法被选中
                setTimeout(function () {
                  _this3.isFunctionRunning = true;
                }, 100);
              case 5:
              case "end":
    ...
    // 获得底部弹窗的的图片和标题
    onShowInfo: function onShowInfo(img, tte) {
      this.showPopup = true;
      this.popupImage = img;
      this.popupTitle = tte;
    },
    ...
    // 点击搜索框跳转到搜索页面
    onToSearchPage: function onToSearchPage() {
      // 跳转到搜索页面
      uni.navigateTo({
        url: '../search/search'
      });
...
/***/ 49:
/*!****************************************************************************************************************!*\
  !*** /Users/lijun/LocalWarehouse/wx-miniapp-cakestore/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 50:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/lijun/LocalWarehouse/wx-miniapp-cakestore/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
