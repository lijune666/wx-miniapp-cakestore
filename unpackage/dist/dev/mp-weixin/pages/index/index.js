...
try {
  components = {
    cakeclass: function () {
      return __webpack_require__.e(/*! import() | components/cakeclass/cakeclass */ "components/cakeclass/cakeclass").then(__webpack_require__.bind(null, /*! @/components/cakeclass/cakeclass.vue */ 69))
    },
    cakeitem: function () {
...
var _default = {
  ...
  methods: {
    ...
    // 获得底部弹窗的的图片和标题
    onShowInfo: function onShowInfo(img, tte, i) {
      var _this4 = this;
      this.showPopup = true;
      this.popupImage = img;
      this.popupTitle = tte;
      ...
      uni.request({
        ...
        success: function success(res) {
          _this4.cakeSizeIndex = res.data;
          _this4.sigleCakeSizeName = _this4.singleCakeSizeIndex.map(function (key) {
            return _this4.cakeSizeIndex[key];
          });
          _this4.choseSize = _this4.sigleCakeSizeName[0];
        }
      });
    },
    // 点击+或-触发获得数量选择器的值
    ...
    // 改变选中的规格样式
    onChangeSizeClass: function onChangeSizeClass(size, index) {
      this.sizeTemp = index;
      this.choseSize = size;
    },
    // 关闭底部弹窗
